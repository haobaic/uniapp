<template>
	<view class="shop-cart">
		...
		<!-- 自定义导航 -->
		<uniNavBar title="购物车" :right-text="isNavBar?'完成':'编辑'" fixed="true" status-bar="true" @clickRight="isNavBar=!isNavBar" />
		<!--商品内容-->
		...
		<view class='shop-foot'>
			...
			<template v-else>
				<view class='foot-total'>
					<view class='foot-count' style="background-color: #000000;color: #fff;">移入收藏夹</view>
		...
		<template v-else>
			<!-- 自定义导航 -->
			<uniNavBar title="购物车" fixed="true" status-bar="true"  />
