	...
	<view class='confirm-order bg-active-color'>
		...
		<view class='order-map' @tap="goPathList">
			<template v-if="path">
				...
				<view class='map-city'>收货地址:{{path.cityName}}{{path.desc}}</view>
			</template>
			<template v-else>
				<view class='map-name'>请选择收货地址</view>
			</template>
		</view>
		<!--商品-->
		...
		<view class='order-foot'>
			...
			<view class="confirm" @tap="goPament">提交订单</view>
		</view>
